...
<h4 class="highlight-color">Social-ecological systems modeling, valuation, and decision science</h4>
...
<h4 class="highlight-color">Natural capital and green accounting</h4>
...
<h4 class="highlight-color">Marine management</h4>
